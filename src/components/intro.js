    ...
    <section className={introStyles.section}>
      ...
      <Container>
        ...
        <p>
          ...
          contact you to work out your Project Airtime flight details. You'll go
          over travel and lodging logistics, as well as any flying specifics. If
          you have a question about flying, he has the answer. Flying normally
          takes place at Point of the Mountain, Utah, but can be arranged in
        ...
        <p>
          ...
          think would be of service to the team, please fill out our{" "}
          <Link to="/#contact">form</Link> below, or shoot us an email and we'll
          be in touch. We're currently looking for people with expertise in
          partnerships, promotions and fundraising, though all support is
          welcome.
        </p>
      </Container>
    </section>
